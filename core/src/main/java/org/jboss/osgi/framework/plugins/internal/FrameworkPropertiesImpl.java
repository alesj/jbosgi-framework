...
public class FrameworkPropertiesImpl implements FrameworkProperties
{
   ...
   /* (non-Javadoc)
    * @see org.jboss.osgi.framework.plugins.FrameworkProperties#setProperties(java.util.Map)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.jboss.osgi.framework.plugins.FrameworkProperties#getProperty(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.jboss.osgi.framework.plugins.FrameworkProperties#setProperty(java.lang.String, java.lang.String)
    */
   @Override
