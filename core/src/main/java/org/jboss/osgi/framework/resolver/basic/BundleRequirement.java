...
{
   private DeployedBundleState bundle;
   private PackageRequirement packageRequirement;
   private BundleCapability wire;
   
   BundleRequirement(DeployedBundleState bundle, PackageRequirement packageRequirement)
   {
      if (bundle == null)
   ...
   DeployedBundleState getImportingBundle()
   {
      return bundle;
   }
